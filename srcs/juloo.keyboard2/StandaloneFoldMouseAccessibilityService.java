...
/**
 * Independent floating FoldMouse touchpad.
 *
 * This service is deliberately separate from the keyboard-integrated mouse.
 * It gets its own accessibility shortcut, cursor, overlay and gesture state.
 */
public class StandaloneFoldMouseAccessibilityService extends AccessibilityService
{
  private WindowManager _windowManager;

  private LinearLayout _padWindow;
  private WindowManager.LayoutParams _padWindowParams;
  private float _dragStartRawX = 0f;
  private float _dragStartRawY = 0f;
  ...
  // Live LMB state, copied from the tested FoldMouse implementation.
